...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        //stmt.execute(String.format("INSERT INTO players VALUES (NULL, '%s', TRUE, 0, 100)", nameExample));
        ...
        while (results.next()) {
            ...
            int scoreTotal = results.getInt("score");
            double health = results.getDouble("health");
            System.out.println(id + " " + name1 + " " + isAlive + " " + scoreTotal + " " + health);
        }
    }
}
